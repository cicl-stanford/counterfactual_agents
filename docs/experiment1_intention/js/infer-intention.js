...
jsPsych.plugins['infer-intention'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for(var j=0; j < slider_labels.length; j++){
      ...
      html += '<div style="display: inline-block; position: absolute; left:'+left_offset+'%; text-align: center; width: '+width+'%; margin-top: 0.4em; line-height: 1em;">';
    ...
    // add submit button
    html += '<br> <button id="jspsych-html-slider-response-next" style="margin: 0 1em 3em 1em;" class="jspsych-btn" disabled>'+button_label+'</button>';
